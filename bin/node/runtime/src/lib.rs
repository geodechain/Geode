...
parameter_types! {
	...
	pub const PreimageBaseDeposit: Balance = 1 * CENTS;
	// One cent: $10,000 / MB
...
parameter_types! {
	...
	pub const TipCountdown: BlockNumber = 7 * DAYS;
...
parameter_types! {
	pub const BasicDeposit: Balance = 10 * CENTS;       // 258 bytes on-chain
	pub const FieldDeposit: Balance = 3 * CENTS;        // 66 bytes on-chain
	pub const SubAccountDeposit: Balance = 3 * CENTS;   // 53 bytes on-chain
...
parameter_types! {
	pub const ConfigDepositBase: Balance = 5 * CENTS;
	pub const FriendDepositFactor: Balance = 500 * MILLICENTS;
	pub const MaxFriends: u16 = 9;
	pub const RecoveryDeposit: Balance = 5 * CENTS;
}
...
parameter_types! {
	pub const CandidateDeposit: Balance = 10 * CENTS;
	pub const WrongSideDeduction: Balance = 2 * CENTS;
	pub const MaxStrikes: u32 = 10;
	pub const RotationPeriod: BlockNumber = 80 * HOURS;
	pub const PeriodSpend: Balance = 500 * CENTS;
...
parameter_types! {
	...
	pub const MinBid: Balance = 100 * CENTS;
...
parameter_types! {
	pub const CollectionDeposit: Balance = 100 * CENTS;
	pub const ItemDeposit: Balance = 1 * CENTS;
...
parameter_types! {
	pub const MigrationSignedDepositPerItem: Balance = 10 * MILLICENTS;
	pub const MigrationSignedDepositBase: Balance = 20 * CENTS;
...
const ALLIANCE_MOTION_DURATION_IN_BLOCKS: BlockNumber = 7 * DAYS;
...
parameter_types! {
	...
	pub const AllyDeposit: Balance = 10 * CENTS;
